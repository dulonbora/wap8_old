...
$ViewRs = $songs->RandomAlbum($start, $limit);
  ...
  <!-- / side content --> <section> 
     <section class="vbox animated fadeInRight"> 
         <section class="scrollable padder-lg"> 
            ...
            <div class="row row-sm"> 
                 ...
                 <?php 
                        ...
                        $sname = str_replace(' ', '-', $row['ARTIST_NAME']);
                        ?>
        ...
        <div class='center text-center m-t-n'>
            <a href='/singer/<?php echo $row['ID'];?>/<?php echo $sname;?>.html'><i class='icon-control-play i-2x'></i></a>
        </div>
        ...
        <div class='top'>
                ...
                <a href='/singer/<?php echo $row['ID'];?>/<?php echo $sname;?>.html'><img src='/image/<?php echo $image;?>' alt='' class='r r-2x img-full'></a>
            </div>
            <div class='padder-v'>
                            <a href="/singer/<?php echo $row['ID'];?>/<?php echo $sname;?>.html" class="text-ellipsis"><?php echo $row['ARTIST_NAME'];?></a>
            </div>
        </div> </div>
                        <?php } ?>
