...
class AlbumsAdmin {
    ...
    $query = "INSERT INTO CLIENTS (LANGUAGE_ID, ALBUM_NAME, PRODUCTION, YEAR, ART_LINK, "
...
return $success;}
    ...
    public function getTotal(){
       $Q = "SELECT COUNT(*) AS TOTAL FROM ALBUM WHERE NEWOLD != 3 ";
       $total = 0;
       try{
    ...
    public function AlbumByCat($start, $limit, $cid){
       ...
       return $result;
        ...
        public function LoadAlbumsInAdmin($start, $limit){
       $Q = "SELECT * FROM ALBUM WHERE NEWOLD != 3 ORDER BY ID DESC LIMIT ".$start." ," . $limit ." ";
       $result = null;
       try{
        $stmt = $this->conn->query($Q);
        $stmt->execute();
       ...
       return $result;
        ...
        public function LoadAlbumsInAdminFake($start, $limit){
       $Q = "SELECT * FROM ALBUM WHERE NEWOLD = 3 ORDER BY ID DESC LIMIT ".$start." ," . $limit ." ";
       $result = null;
       try{
        $stmt = $this->conn->query($Q);
