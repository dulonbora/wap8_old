                                        ...
                                        <div class="blog-post"> 
                                            ...
                                            foreach ($ViewRs as $row) {
                                                ...
                                                <div class="post-item"> <div class="post-media">  </div>
                                                    <div class="caption wrapper-lg"> <h3 class="post-title">
                                                            <a href='blogview.php?i=<?php echo $row['ID']; ?>'><?php echo $row['HEADLINE']; ?></a></h3> 
                                                        <div class='post-sum hidden-sm hidden-xs'> <p><?php echo $s; ?></p> </div>
                                                        <div class="line line-lg hidden-sm hidden-xs"></div>
                                                        <div class="text-muted hidden-sm hidden-xs"> <i class="fa fa-user icon-muted">
