...
$ViewRs = $Albums->LoadAlbumsInAdminFake($start, $limit);
...
<div class="row">
                                    ...
                                    <section class="panel panel-default"> <header class="panel-heading">Album List (<?php echo $Total;?>) <span id="ResultMassage"></span></header> 
                                        <div class="row wrapper">  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 m-b-xs"> 
                                                <div class="btn-group" data-toggle="buttons"> 
                                                    <button id="addnew" class="btn btn-sm btn-success btn-rounded btn-block">Add New Album</button>
                        ...
                        <tr>
                            <td>
                                <a href="manage_album_songs.php?i=<?php echo $rows['ID'] ;?>"><?php echo $rows['ALBUM_NAME'] ;?></a>
                            </td>
