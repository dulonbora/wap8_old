...
<div class="row">
                                <div class="col-lg-12">
                                    <section class="panel panel-default"> <header class="panel-heading">All Artist List <span id="ResultMassage" class="text-danger"></span></header> 
                                        <div class="row wrapper">  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 m-b-xs"> 
                                                 
                                                    <a href="Post_Add_New.php" class="btn btn-success">Add New Post</a>
                                                     </div> <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8"> <div class="input-group"> 
