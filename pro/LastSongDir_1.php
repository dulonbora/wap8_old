                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                                    if (!empty($_FILES["file"]["name"])) {
                                                        ...
                                                        if ($ext == "mp3") {
                                                            if (!$temp_name) { // if file not chosen
                                                            ...
                                                            if (move_uploaded_file($temp_name, $target_path)) {
                                                                ...
                                                                Redirect("LastSongDir.php?i=" . $id . "&l=" . $l);
                                                                exit();
                                                            } else {
                                                                echo "temp" . $temp_name;
                                                                echo "tar" . $target_path;
                                                            }
                                                        } else {
                                                ...
                                                <h3>Upload Mp3</h3>
                                                <h5><?php echo $dir_path; ?> <a class="btn btn-sm btn-danger pull-right" href="SubDir.php?i=<?php echo $l; ?>">Back</a></h5>
