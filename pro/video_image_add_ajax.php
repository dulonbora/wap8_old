<?php include '../classes/Videos.php';
...
<div id="imageview" class="text-center">
    <img class="text-center" src="../image/<?php echo $albums->getPIC();;?>" width="300" height="200"/>
</div>
    <form action="img_Upload_video.php" method="POST" name="form2" id="uploadForm" enctype="multipart/form-data" role="form" > 
